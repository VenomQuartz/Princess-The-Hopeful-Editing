...
Menders regain magic when they provide consolation, comfort, and aid. They can volunteer their time at medical facilities or provide home care, work at emergency hotlines, design new treatments, be a shoulder for someone to cry on, or do any other number of things to relieve the pain of others. 
...
\section*{Oaths}
\noindent \textbf{First Oath:} To be a healer is a sacred trust. My patients put their bodies and minds in my care, so above all else, I vow to do my patients no harm and respect their autonomy. The healer's sacred duties have survived the fall of our Kingdom, and I am proud to uphold their traditions. \\
...
A Wilds echo tends to give people a feeling of serenity. People feel calm and peaceful around the Princess, as if her mere presence somehow brings the world into greater harmony.

\subsection*{Practical Magic}

The Queen of Clubs teaches her students that conflict is a cycle that must be broken, and that her Court can find strength or victory through refusing battle. Once a scene, when a Wild is the target of a resisted or contested action, she may spend 1 Wisp to twist her opponent’s action in her favor. Either the Princess's resistance won't apply, or she gets no successes in the contest. If her opponent succeeds, she imposes a negative Condition on her opponent or takes a positive Condition herself. This can be any Condition reasonable for that situation. If none seem suitable, an improvised Condition [CofD 76] can be used. The Condition should be of a similar strength to the effect that the other character is trying to inflict on the Princess. The Storyteller remains the final arbitrator of which Conditions are acceptable.
%Editor: I wasn't sure I understood the third sentence ("Either the Princess's..."). If it's not clear already, I am not actually very familiar with Chronicles of Darkness as mechanically. Anyways, I tried rewording the third sentence. Please check if it's stil says what you meant it to say. 

High Belief softens the blow from the force the Wild redirects. At Belief 8, the Princess adds 1 to the successes her opponent needs for an exceptional success. At Belief 9, she adds 2. At Belief 10, she adds 3. For example, at Belief 8, her opponent needs 6 successes to score an exceptional success. 
...
%Editor: I'm still not able to find what conversation styles are in any official books. Please clarify. Also, is large unit tactics a merit? 
...
%Editor: Question: How do quotation marks work in Latex? I've tried looking it up for myself but couldn't figure it out. Are normal quotes like I have there enough? 
...
%Editor: NTS Must check about two crowns and women beneath the crown???
...
In ordinary times, Gallants are courteous, friendly, and compassionate to all and perform their duties with dignity and diligence. But they have their burden, heavier than most, and they don't allow themselves to forget it. Moreover, they must not take their position for granted. If her society rejects a Flower's rule, or deposes her from it, the fault is hers, not theirs, and if that society then proceeds to a disaster that she would have avoided, her failure to gain their trust is all the more grievous.
