...
A Princess's magical body is more than a match for size and leverage. (A complete list of special rules for adult-child interactions can be found in \textbf{Innocents}, page 193). How this manifests is up to the player. A Princess with Transformed Composure might acquire adult emotional maturity every time she Transforms or overcome her fears through a supernaturally potent child-like sense of adventure. 
...
To take two dots in a Charm, you must also take one dot in a different Charm of the same family. To take three dots in a Charm, you must take three dots worth of Charms in the same family. (For this purpose, an upgrade counts as a single dot.) If the Charm has a prerequisite on an Invocation, you may treat it as part of a pseudo-family and use it to unlock access to other Charms that depend on the same Invocation. 
%Editor: What does "If the Charm has a prerequisite on an Invocation" mean? Can it be reworded to "If the Charm's prequisites include an Invocation"? 
...
Belief tracks the strength of a Princess's convictions. It replaces the Integrity system from \textbf{God-Machine Chronicle}. Where Integrity measures how a character copes with traumatic and supernatural events, Belief only represents a Princess's ability to cope with trauma and pain. (Since they themselves are supernatural, Princesses don't need to cope with the supernatural.) Belief is the core of inner strength and hope that allows a Princess to carry on even while she is suffering more than anyone could bear. Belief works together with the Sensitivity system, which represents how much emotional pain a Princess is dealing with. 
...
A Princess's magic flows from her Belief. Destroying her self-confidence can be an effective way to weaken her powers and a devastating precursor to a physical attack. The rules for Social Maneuvering (\textbf{Chronicle of Darkness}, page 81) can be applied for this purpose.
...
When a Princess drops to Belief 0, the final act that broke her Beliefs inflicts the Soulless (\textbf{Chronicle of Darkness}, page 290) and Enervated Conditions. For as long as her Belief remains zero, she cannot access any of her powers from the Princess template. Since the Princess's soul is not actually missing, just falling apart, finding a replacement soul cannot heal her. The only solution is for the Princess, with the help of her friends, to rediscover her Belief before she loses her last dot of Willpower. Her friends can do this using the Social Maneuvering rules [\textbf{Chronicle of Darkness}, pages 81-84]; the number of Doors they must open equals twice her Shadows dots. If all the Doors are opened, and the Princess spends 2 Experiences and sacrifices a Willpower dot, she can remake her Phylactery, return her Belief to 1, and end the Soulless and Enervated Conditions.
...
In terms of gameplay, this doesn’t have much effect. If you can only justify earning a Transformed dot now but want a mundane dot, you can usually fit one Experience worth of training into the next downtime. 
...
%Editor: Would you consider changing the name of the Stereotype section (and other similar sections) to something like "How Champions See Others"? 
\section*{Concepts}
...
%Editor: Would you be interested in adding the work the characters originate from in parentheses? For example, we could have "the Sailor Senshi (\textit{Sailor Moon])"
...
A Seeker regains Wisps whenever she uncovers new information or teaches another something new. A Seeker could be a scientist or explorer uncovering secrets no one has ever known. She could be a detective uncovering that which the unscrupulous have hidden. She could be a teacher passing what she knows to the next generation. Many Seekers do both. A reporter uncovers a political scandal, then she publishes it. A professor does exciting research, then writes a paper and gives lectures on it. 
%Editor: It's not clear what "Many Seekers do both." is referring to in this paragraph. Please clarify. 
...
Socially, the Court of Clubs tends to have fewer dots in Allies than Contacts. It is the way of Clubs to coexist, not control. Circle, however, is often very high, as the Court's focus on coexistence brings them closer to whoever is around them. It is not unknown for a Wild to count an entire community as their Circle; that community can range from an ordinary suburban neighborhood to a close-knit commune. The outdoor life enjoyed by many Wilds makes Physical Merits common: Many are exceptionally healthy people who enjoy a Natural Immunity and a good Direction Sense. Mental Merits are rarer, but a Meditative Mind and Holistic Awareness are both common in the Court of Clubs. In conversation, many favor the Wisdom style.
...
The Queen of Clubs teaches her students that conflict is a cycle that must be broken, and that her Court can find strength and victory through refusing battle. Once a scene, when a Wild is the target of a resisted or contested action, she may spend one Wisp to twist her opponent’s action in her favor. Either the Princess's resistance won't apply, or she gets no successes in the contest. If her opponent succeeds, she imposes a negative Condition on her opponent or takes a positive Condition herself. This can be any Condition reasonable for that situation. If none seem suitable, an improvised Condition [\textbf{Chronicles of Darkness}, page 76] can be used. The Condition should be of a similar strength to the effect that the other character is trying to inflict on the Princess. The Storyteller remains the final arbitrator of which Conditions are acceptable.
...
%Editor: Significantly reworded third sentence. Please check if meaning was preserved. 
...
\section*{Stereotypes}
%Editor: As with the previous Stereotypes sections in Callings, I think it would be useful to retitle this section and/or provide additional context about who holds these stereotypes. 
\begin{itemize}
...
%Editor: I've mentioned this before, but I think having Diamonds Princesses be called Lights is confusing. I'm gonna leave instances alone here, but I really recommend removing it as a epithet. 
...
%Editor: I gotta say, the river/tributary metaphor is really good and quite clever. 
...
%Editor: Significantly reworded the first sentence. Please check. 
...
If The Queen of Diamonds' Seekers are scientists, then her Menders are engineers. A Mender of Diamonds is more likely to be found in a laboratory than in a hospital. Rather than fixing a broken machine, she will design a new machine free of the fault of the original. The Hope-Engineers can be found in research and development teams, developing technological policy, contributing to open-source work, and running crisis response centers.
%Editor: I think the use of "Hope-Engineers" here to refer to only Menders muddies the definition of both terms. I recommend replacing with just "These Menders." 
...
Despite their Queen's love of science and technology, it is not necessary for a Hope-Engineer to be (or aspire to be) a scientist or work in a technical field. Only around half the (adult) Court work in an academic or technical profession, which includes librarians and teachers. Regardless of background, most of the Court sincerely believes in the potential for technology to create a better world. 
%Editor: I cut some parts of this paragraph. Check please. 
...
Socially, the Court of Diamonds favors Contacts, for the access to information it provides. Many find themselves joining scientific or engineering projects, and a tight community with shared goals can easily lead to both Mandate and Allies. Those who work as ambassadors typically pick up the Scientific Rhetoric conversation style. More than any other Court, the Hope-Engineers enjoy access to mental Merits. Many have strange abilities such as an Eidetic Memory or Common Sense granted to them by their Blossoming. Others have studied all their life and have abilities like Encyclopedic Knowledge to prove it. Champions of Diamonds usually have know Small Unit Tactics. (The only reason they don't have large unit tactics is because it's so hard to get a large unit).
%Editor: I'm still not able to find what conversation styles are in any official books. Please clarify. Also, is large unit tactics a Merit? I can't find it in any official books, nor can I find it in this book. 
...
%Editor: Brought up a similar thing before, about ambiguous wording in first sentence. Do Crystals master Acqua faster than other Princesses, or do Crystals master Acqua faster than other Invocations? 
...
Though a diplomat by nature and profession, the Prince Consort is also known as the Queen's Champion. He does not defend his wife's life, for any foe that can threaten a Queen has nothing to fear from a Prince. He defends the Queen's honor, for in the Court of Hearts, it is considered proper for the stronger fighter in duels to take a handicap. When one is as powerful as a Queen, the only possible handicap is to send a champion to fight in your place.
%Editor: Is the Prince's Calling that of a Champion, or is he just the queen's champion?  
...
%Editor: The differing use of Flowers and Gallants here implies that only Flowers replace bad traditions with good ones and only Gallants take traditions from past lives. I assume that wasn't the intention, so I replaced both with Jewels. 
...
%Editor: Changed second sentence. Please check meaning is still same. 
...
%Editor: Note similar to previous Invocations about Jewels learning their Invocation.
...
%Editor: I'm not understanding the meaning of the second sentence. Could you please reword? 
...
%Editor: I tried rewording the last sentence, but I still don't really get what it means, especially the second clause. Please clarify. 
...
%Editor: Added extra uses clarification, since it was in the other Practical Magic sections. Max three extra is correct, right? 
...
%Editor: Do you want to leave this bit commented out? 
...
If there is a mundane solution, the Princess will try that first. (She at least \textit{should} try it first. There's no sense in needlessly revealing one's secret identity.) If she has appropriate mundane equipment, its equipment bonus increases by Fuoco. If the Princess leaps over a barrier, she adds Fuoco feet to her maximum jumping distance. Otherwise, she can tear through the obstacle if its Durability is less or equal to her (Strength – 4). If the barrier is supernatural or supernaturally reinforced, a Clash of Wills ensues. If the Princess wins, treat the barrier as mundane. Otherwise, she cannot breach it. Any damage inflicted is permanent.
%Editor: Sorry, this might be obvious to someone who knows the game better, but who/what is the last sentence referring to? The Princess? The barrier? Both? 
...
%Editor: Is this line equating fire and humanity? Just asking in case we need to pluralize "thing." 
...
Princesses usually keep an eye out for Beacons. If a Beacon is in trouble, the Princess will intervene before Beacon’s idealism fades and their Light is crushed. There are also pragmatic reasons to keep an eye on Beacons: Their light tragically makes them a target to creatures of the Darkness they encounter, and they are disproportionately likely to Blossom. Being ready to ease a new Princess into her role can make a world of difference. But even if that weren’t so, the Hopeful would seek out Beacons anyway, just for the pleasure of their company.
%Editor: Here, when light is mentioned, is it THE Light, capital L Light, or is just the Beacon's goodness? Please be more precise. 
...
Beacons can use Bequests, items that give the wielder the ability to cast a Charm. Beacons roll Integrity to transform a Bequest. As Beacons have no Wisps, they are limited to Bequests with their own pool of Wisps or Bequests containing Charms that do not require Wisps to use. If the Charm's effects vary with Inner Light, a Beacon is treated as having a single dot of Inner Light.
%Editor: What does it mean to transform a Bequest? 
...
%Editor: Reworded the clause about buying supernatural abiltiies. Is this the intended meaning, that Beacons can only buy two kinds of supernatural abilities?  
...
%Editor: Could you reword the second clause of the last sentence? A bit confused by it. 
...
The Sworn fill many roles. Sometimes, a Princess is impressed by a mortal (or a Beacon) and offers them magic. This is an significant investment: Not only must the Princess invest a portion of her power to create a Sworn, she must also make Bequests to provide the Sworn with Wisps and Charms. Other Sworn work closely with the Nobility. A team of Princesses who notice a gap in their skills could seek out a new member who has the mundane abilities. The powers of a Sworn and a few Bequests can provide the magical skills.
...
Princesses sometimes create Sworn for special tasks. For example, a Princess might give Bequests that grant deep insights into legal code to a think tank drafting a complex new law about social justice. If it works, a simple investment could have an enormous long-term payoff, but such plans are risky. The Princess usually ends up running against one or more of the vested power groups within the World of Darkness.
...
Sworn may travel to the Dreamlands but (barring the Dream Traveler Merit) they require the Girl Underground Condition or a Princess to show them a Crawlspace entrance every time. Once they have seen a Crawlspace entrance, they use the same mechanics as Princesses (but they would still not be able to manifest Regalia). 
%Editor: Does this mean that Sworn need Princesses to show them a Crawlspace entrance every time they enter the Dreamlands, even if the Sworn has seen the Crawlspace before, or do Sworn only need to be shown new Crawlspaces? 
...
%Editor: See previous note about similar line with Beacons. 
...
Shikigami are Dreamlanders who have formed a symbiotic bond with a Princess. Her magic sustains the Shikigami, allowing it to remain upon Earth indefinitely. In return, it aids her with its knowledge and magic reflected from her Light.
%Editor: I don't understand what "reflected from her Light" means here. 
...
%Editor: What does "similar results" mean here? 
...
%Editor: Changed "sever all ties to their bodies" to "sever all ties to their BODY." Was the plural intentional? Can a Shikigami possess multiple bodies in the waking world at once? 
...
Shikigami have a Wisp pool equal to their Integrity. Shikigami automatically gain a Wisp every time a Princess they are bound to gains a Beat from an Aspiration or Dream. (Dreams grant one only Wisp, not one for each kind of Beat.) Princesses can also transfer Wisps directly to their bonded Shikigami; this requires physical contact and one minute of time. While touching is enough, petting, grooming, and playing all make it easier. Without a bond, a Shikigami has no natural way to regain Wisps and must rely on somebody who knows the Charm Charge. 
%Editor: What does "not one for each kind of Beat" mean? 

While Transformed, a Shikigami can use Charms. However, the maximum Charm rating a Shikigami can have is limited by the highest Inner Light among the Princesses the Shikigami is bonded to. At Inner Light 1, a Shikigami can learn Charms at one dot. Every two dots of Inner Light increases this limit by one. Shikigami have no affinity for any Charm trees. This ersatz Inner Light rating also applies when a Shikigami uses a Charm with effects that vary by Inner Light.
...
%Editor: Had a tough time with this paragraph. Tried rewriting to smooth it out. Does it still mean what you want it to mean? 
...
Shikigami may buy physical abilities for their body as Merits. A Shikigami with wings can fly at its usual speed for four Merit dots. One with sharp teeth or claws may buy damage zero or one weapons for one or two Merit dots, respectively. Physical abilities that emerge or enhance when a Shikigami Transforms should be represented by acquiring Charms. 
%Editor: Does "one weapons" mean having one dot in Weaponry? What does "damage zero" mean? 

Finally, Shikigami begin play with five points of Experiences, which they may spend upon Merits (including physical abilities), Transformed Abilities and Skills, Charms, and Invocations.
