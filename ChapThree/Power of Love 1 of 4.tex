...
The name you choose is a promise, and the Enlightened have chosen the name “Noble.” The Radiant know they are the example — they can't help it — so they have promised to be a good example. When a Noble is at her best, people take notice. They are impressed and want to imitate her. When a Noble loses heart, people notice, and it \textit{scares} them.  

This is magic, but only a little bit. A Princess's Inner Light makes her every action, good or bad, shine brighter. Human empathy does the rest. This effect a Princess has on others is called the Princess's Echo. 

Whenever the Princess fulfills one of her Virtues, roll Belief. On a success, everyone who witnessed the Princess gains the Inspired condition, which they may use on any roll to act in accordance with that Virtue. 
...
%Editor: What's Supernatural Advantage here? I know what Advantages are, but is Supernatural a specific kind of Advantage? If so, where in the books is it mentioned? 

Generally, Echoes don't provide Princesses with any advantage over their antagonists or enemies. If a police officer forces a vigilante Champion to stand aside for the authorities, he won't be Shaken by her hurt feelings. Her feelings will be more noticeable, but the officer's own belief in the importance of due process is more than enough of a shield. This goes double for people who actually want the Princess to suffer. While a foe sometimes has a “my god, what am I doing?” moment, any Princess who expects her Echo to protect her is an idiot. If you prefer more defined rules for when a Princess's Echo can help her against her antagonists, try this: A character who triggers a Princess's Echo by acting in accordance with their Virtue or Aspirations (or equivalent) will not be Shaken by by it. 
...
The most essential expression of a Princess's power is the ability to Transform. She calls on her magic and assumes the form of her perfected self, a self version unfettered by this world of sorrows. Although she can only maintain this immense power for a limited time, a Transformed Princess is a force to be reckoned with.

The first time a Princess Transforms is called her Blossoming. This is an unconscious act, usually in response to some great need or danger. After her Blossoming, the Princess's Phylactery will manifest. This is the physical representation of the power sealed away inside of her, and it can take the form of any small simple object. She must have her Phylactery with her later to Transform. When a Princess wishes to Transform, she has two options: She may either spend a Wisp or make a Transformation roll. If she spends a Wisp, she Transforms automatically as a reflexive action. The Transformation roll is Belief + Inner Light - Shadows. 
...
\begin{myindentpar}{10pt}
	...
	%Editor: The exceptional success and failure outcomes both say that a Princess can stay Transformed for an upcoming scene or a certain amount of time. Is this a whichever comes first kind of situation? For example, for failure, is it the case that the Princess can stay Transformed for the next scene, or the next half-hour, whichever comes first? 
\end{myindentpar}
...
Every Princess has a Phylactery, a physical item that symbolizes exactly what being a Princess means to her. A Phylactery is also the source of a Princess's power to Transform. She must use or touch it to Transform. This limit affects anything described as a Transformation action. Many Phylacteries also Transform with the Princess, becoming larger and more ornate or becoming the Regalia linked to a Charm strongly associated with her duties. (A Phylactery is simply a specialized piece of Regalia and shares most of their rules). Other Phylacteries remain as they are but are incorporated into her Heraldry. 

A Phylactery has a Durability equal to Inner Light and a Structure equal to Belief. Typically, its Size will range from 0 to 2. If her Phylactery is destroyed or lost, the Princess can recreate or summon it. She must spend a Wisp and a point of Willpower and concentrate for a full round. 

If another were to steal a Princess's Phylactery, they would be unable to use it, but they would be able to target the Princess through an unbreakable Intimacy link with a strength equivalent to love. Fortunately, any technique that would cut the connection Princesses use to summon her Phylactery would, by definition, destroy it.
%Editor: I don't understand the last sentence. Can you reword it? 

\section*{Dual Identity}
\phantomsection
\label{sec:DualIdentity}

One aspect of the Hopeful's transformation is subtle but amazingly convenient: The mundane and Transformed selves always appear to be different people. They might not look \textit{very} different — only as different as Clark Kent and Superman, maybe. But differences in the Princess's posture and bearing, along with powerful magical protection, make the idea that they are the same person laughable. Simple Perception rolls cannot reveal that a Noble's two identities are connected, nor can a simple Subterfuge or Empathy roll uncover the Princess's deception when she claims to have only one identity. 

Learning a Princess's secret identity requires ironclad proof, such as personally witnessing the Princess Transform. If the proof is solid but not irrefutable, such as finding the Princess's mundane ID in her Transformed self's possession, the investigator may make a roll to uncover her identity there and then. Usually, this would be a Contested Wits + Empathy vs. Manipulation + Subterfuge roll as the Princess makes her excuses. 
...
\begin{myindentpar}{10pt}
    ...
    \emph{The Princess wins the roll:} The investigator fails to penetrate the Princess's dual identity but gains a Clue that will help in future investigations. 
    
    \emph{The investigator wins the roll:} The investigator identifies the Princess correctly.
...
If the Princess rolls an exceptional success, downgrade her investigator's result by one step: Exceptional successes becomes successes, successes becomes failures, and failures become dramatic failures. Conversely, if the Princess rolls a dramatic failure, upgrade the investigator's result by one step.

If the investigator doesn't have a smoking gun, the only other way to uncover the Princess's identity is to undertake a full investigation which requires at least five Clues to Uncover the Truth — more if the Princess has the Veiling Merit. Princesses need to be careful about their identities: Both friends and enemies will be curious about her secret. 

If a player's Princess is investigating an opposing Noble, she may use the rules for investigations as written (see \textbf{Chronicle of Darkness}, pg. 79). Unless she is distracted or dissuaded from continuing, she will eventually succeed. The question is how long it takes and what dramatic complications she faces on as a result. 

But if the players' Princesses are the ones being investigated, change the rules as follows: For player characters, every Clue should be directly linked to a mistake they made on screen. For example, a Princess sneaking away to the bathroom only for the Transformed self to reappear could be a clue. If the Princess calls from a place her mundane self shouldn't be but that her Transformed self has been, that's a Clue. If she leaves her mundane identification behind while Transformed, that is \textit{definitely} a Clue.

Unless the players have gotten extremely careless, Storytellers should avoid having a supernatural antagonist follow Princesses back to their mundane lives. Instead, as the Princesses create more Clues, Storytellers should show signs of an investigation progressing. An ally can warn the Princesses about people asking suspicious questions. Suspicious vans can be parked near areas the Transformed Princesses are known to frequent. A Princess's mundane identity might even be interviewed as a potential witness. If nothing else makes sense, a player character could have a prophetic dream warning her that she's under investigation. This gives the players a chance to stop or at least slow the investigation.  

A careful balance must be struck. Players should not be able to play fast and loose with their secret identity and then cover everything up at the last moment. But at the same time, having a mundane life is thematically important to \textbf{Princess}, so if a Princess's loved ones are harmed, the players should \textit{always} think “this is fair, this happened because I screwed up.” 

That said, if player characters befriend someone whose mundane self has supernatural traits, then that character will naturally remain exposed to the occult world and its dangers. Even Beacons, who cannot hide their Light like Princesses, can find themselves targeted by the Darkness.

Storytellers could consider tracking major blunders like talking about one's school while Transformed separately from minor events like regularly sneaking off to the bathroom to Transform, using the first for serious threats and the latter to introduce low-threat antagonists like mortal YouTube journalists for players to bamboozle or persuade. For serious threats, a Storyteller might consider withholding second chances if a player repeats a mistake that already caused them trouble, reducing the amount of breathing room players have to cover up old mistakes as the story progresses, or being especially harsh on mistakes made during an active investigation. 

Supernatural powers that could reveal a Princess's identity are also blocked by the innate protections guarding her dual identities. Introducing an antagonist whose powers could discover and attack the Princess's mundane family without any mistake on her part will hardly qualify as a fair game. Any supernatural power that would outright reveal the Princess's identity will fail: Reading a Princess's mind will not reveal her secret or directly uncover Clues, though it might provide leads to investigate. 

Abilities that detect the presence of the supernatural, such as the Charm Reflected Light, will not detect a Princess in her mundane identity. (This is not surprising; without an external source of power, like a Bequest or a Queen, a non-Transformed Princess only has her Echo, which is barely magical at all). Even abilities that specifically detect the presence of Light fail. A non-Transformed Princess converts a little of her Light into her Echo and hides the rest safely in her Transformed self until it is time to use it. The Storyteller may consider relaxing this protection if the player characters are investigating a Princess, but not when playing them. 

Supernatural abilities can certainly assist in an investigation. Reading the minds of witnesses is more effective than interviewing them. Money the Princess handled in both identities could reveal a Clue under Psychometry. If a Princess covers her house with magical defenses and someone else can sense that magic, that is probably enough to earn a roll to identify the Princess there and then. An ability that detects the active use of magic could catch a non-Transformed Princess using Practical Magic. 

\subsection*{Dual Identity and Intimacy}

When targeting a Princess with magic, Intimacy, True Names, and similar traits that connect to one of the Princess's forms does not connect to her in the other form. This is true even if the Princess uses the same name in both identities: There are lots of people called John Smith, and they all have a unique True Name. However, if a Princess interacts with the same person in both forms, her Intimacy can quickly reach parity in both identities. After all, her feelings are usually similar in both identities. Even for those who know her secret, a Princess is still two versions of the same person rather than one person who uses a disguise. If a power is currently targeting a Princess through an Intimacy connection, Transforming automatically causes it to lose track of her. 
\begin{comment}
\subsubsection*{Indiscretion, an optional rule}

The Dual Identity rules above require the Storyteller to keep track of which Clues the players have left behind, which antagonists are investigating the players, and which Clues the antagonists are capable of discovering. Storytellers might prefer to use this simpler system. 

The first time in a scene that a Princess does something that might compromise her identities, she must roll an appropriate dice pool. This could be Wits + Subterfuge if she let details slip in conversation or Dexterity + Stealth to see if she avoided the security cameras when she slipped up.  
\end{comment}

\section*{Practical Magic}

In addition to the immense power Princesses wield in their Transformed identity, the Nobility can also wield Practical Magic. Practical Magic is subtle magic that Princesses can call on in both identities. What Practical Magic a Princess possesses depends upon which Queen she follows. Details can be found under the relevant Queens. 
...
The Mentor Merit detailed in \textbf{Chronicles of Darkness} focuses on relations within mortal and supernatural societies. While both of those can be of great help to a Princess, a further option is available to a lucky few Princesses: personal mentorship from their Queen. Though a Queen cannot leave the Dreamlands, she still has such a wealth of power and experience that she would be far beyond a five-dot Mentor. However, the Queens have many obligations besides tutoring a Princess. Therefore, when applied to a Queen, the Mentor Merit represents not her skill but how much of her attention she will spare the character.

If a Princess gains a Queen as a mentor, do not select three Skills for the Mentor to have. Rather, Queen Mentors can be assumed to have every Skill. Queens are so universally capable that even the Queen of Clubs has the raw intellect and magic to master computer programming in an hour
%Editor: I assumed the World of Darkness rule book mentioned here is actually Chronicles of Darkness/New World of Darkness. Have changed to be so. Also, I split off the aside about Queens and Skills to its own sentence. 

Each dot in Mentor means at least one chance to talk with the Queen per session. A chat can be just a few moments before the throne, but at high dots, it can be significantly longer. After consulting with her Queen, the Princess either gains the Advised condition or more direct clues about what her next steps.

When portraying the Queens, the Storyteller should always remember that they have had no contact with Earth for millennia and are consequently out of touch. Therefore, no matter how many dots a Princess has in Mentor and no matter how important it is, Queens cannot give information on human-kept secrets or the minutiae of current events. Instead, the Queen can teach Princesses how to find this information for themselves.
%Editor: Significantly changed last two sentences. Please check. 

A Princess must follow a Queen before she can place dots in Mentor for that Queen. Neither Storms nor Mirrors will serve as Mentors. A follower of the Queen of Tears cannot place more than three dots of Mentor into her Queen. The Queen of Tear's kingdom is under siege and conforms to the normal rules of time; she just doesn't have the time to spare.

At zero dots, the Princess's Queen will speak to her only on important business. If there's an emergency, the Princesses will usually get a chance to explain and some advice in return. The amount of time received depends on how serious the emergency is and whether the Princess should be able to handle it on her own. Remember that both of these are opinions, and two Queens might see the same situation differently. The Queen of Swords considers losing a boyfriend to be a small crisis, but her own followers often think that's taking things too far.

With one dot, a Princess can usually get the occasional snatch of time whenever there is a lull in court proceedings. This would be enough time to talk about recent events or ask questions and get a brief bit of advice.

At three dots, the Queen often has the Princess's name in the royal itinerary for one-on-one time or group sessions with her Nakama. The Princess has the opportunity to talk at length about her progress and receive private tutoring. She also gets the chance to better know the Queen as a person. Generally, a Princess with three dots of Mentor has something special about her that caught her Queen's eye. The Princess might be the only Onceborn in the Court or have the largest following among the Queen's court. Perhaps she was someone the Queen respected in a past life, or maybe the Princess works full-time as one of the Queen's agents upon Earth and must report in often. (This final option can be especially helpful for beginner players, as it both justifies clear goals for the character and advice from the Storyteller).

At five dots, the Princess is spending at least an hour with the Queen most nights, and the Queen might get worried at the Princess's absence. This level of attention is exceptionally rare, and characters who have five dots are either vital to the Queen's agenda or have an exceptionally strong personal connection. Perhaps the Queen believes the Princess might become a Queen herself and has dedicated herself to making sure it happens. The Princess may be the first Ambassador to a concept the Queen cares for greatly. Perhaps the Queen and Princess might have an immense personal bond of friendship, or maybe the character is the Queen's consort. (This last option is usually only available for followers of Swords).
%Editor: Sorry if this would be obvious to someone who knows the system better. Would it be useful to mention the range of dots and their effects? For example, instead of saying "With one dot," could we say "With one or two dots"? If yes, should the difference in the range be explicated? For example, what's the difference between having one and two dots? 

\subsection*{Retainer (\textbullet+)}

Princesses can have Retainers just like other characters, but Princesses can also have Beacons, Sworn, and Shikigami. 

For a Beacon or Sworn, their magical abilities are basic: Add a single additional dot to both their effectiveness and Merit cost as a Retainer. This remains true even when one person wields both the magic of a Beacon and a Sworn. 

Shikigami who work with or for a Princess can also be represented by the Retainer Merit. Since the typical Shikigami is a person of note in the Dreaming Kingdoms and has access to magic, they're rarely worth less than four dots as a Retainer. As a special rule, a Nakama can split the cost of a Shikigami between them: After all, one of a Shikigami's most useful abilities is to be a magical relay between all the Princesses it is bonded with. Shikigami who come and go as they please or who laze around a Princess's home and dispense advice or clues in-between bingeing on cakes and MMORPGs do not need to be represented by a Merit. 
...
Some Nobles' perfected selves differ so much from their mundane selves that they are excessively difficult to identify, even beyond the norm. A Princess with Veiling is one such; whenever an observer tries to connect her two identities, they subtract Veiling from all rolls, and each dot of Veiling adds an additional Clue as a requirement to uncover her identity. 

If a Princess has Veiling and Anonymity the two merits have distinct roles. Anonymity makes it hard to find information about the Princess (or one of her identities). Once you have that information Veiling makes it hard to connect it to her second identity, or even realize she has two identities. 
